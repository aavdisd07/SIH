...
function Card() {
      ...
      <div className="card-content">
        <div className="employee-info">
          ...
          <div className="employee-details">
            ...
            <div className="emp">
            <p className="employee-role">Role: <br/><b>Head of UI/UX Design</b></p>
            <p className="employee-phone">Phone Number: <br/> <b>(+62) 812 3456-7890</b></p>
            <p className="employee-email">Email Address: <br/><b>sanika@gmail.com</b></p>
            </div>
          </div>
        </div>
  ...
  <div className="history-stat">
    ...
    <div className="history-stat-times">
      <p className="history-stat-text">Check-in Time<br/><span className="highlight-time">08:53</span></p>
      <p className="history-stat-text">Check-out Time<br/><span className="highlight-time">17:15</span></p>
    </div>
  </div>
